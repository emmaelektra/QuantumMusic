...
initial_probs, initial_output_states, _ = exp_setup.run_experiment([0, 1, 1, 1], gate_values=[(0, 0)] * num_gates)
...
def update_plot():
    global last_sample_time, measured_state, flash_alpha, state_counts
    ...
    if time.time() - last_sample_time >= sampling_interval:
        # Run the experiment and get probabilities, output states, and measured state
        probs, output_states_raw, measured_state = exp_setup.run_experiment([0, 1, 1, 1], gate_values=gate_values)
