...
class ESPLED:
    ...
    def get_output(self, input_brightness_1, input_brightness_2, previous_entanglement1, previous_entanglement2):
        ...
        if self.id == 3:
            ...
            self.output_brightness_1 = int((input_brightness_2 * T) + (input_brightness_1 * R)) if self.output_brightness_1 >= 0 else 0
            self.output_brightness_2 = int((input_brightness_1 * T) + (input_brightness_2 * R)) if self.output_brightness_2 >= 0 else 0
